...
Evaluates comment quality across four dimensions: factual accuracy, completeness, long-term value, and misleading elements
...
Usa `@comment-analyzer` cuando necesites:
- Evaluates comment quality across four dimensions: factual accuracy, completeness, long-term value, and misleading elements
