# Harness Optimizer Skill

Analiza y mejora la configuración del harness de agentes local — hooks, routing, context, safety, cost
...
Usa `@harness-optimizer` cuando necesites:
- Analiza y mejora la configuración del harness de agentes local — hooks, routing, context, safety, cost
