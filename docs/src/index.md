...
hero:
  ...
  tagline: "130 skills, 14 stacks de usuario (+common), 4 domain overlays, 22 agentes, sistema de memoria, hooks defensivos y MCPs configurados. Todo listo en menos de una hora."
  actions:
    - theme: brand
...
features:
  - icon: 🧠
    ...
    details: 130 skills y 14 tech stacks de usuario con 4 domain overlays. Los agentes se compilan con skills embebidas por stack — code reviewers, TDD guides, build resolvers, security scanners y más.
