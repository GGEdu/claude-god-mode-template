...
hero:
  ...
  tagline: "130 skills, 13 stacks de usuario (+common), layers técnicos composables, 4 domain overlays, 22 agentes, sistema de memoria, hooks defensivos y MCPs configurados. Todo listo en menos de una hora."
  actions:
    - theme: brand
...
features:
  - icon: 🧠
    ...
    details: 130 skills, 13 tech stacks de usuario y layers técnicos composables (React, etc.) con 4 domain overlays. Los agentes se compilan con skills embebidas por stack + layer — code reviewers, TDD guides, build resolvers, security scanners y más.
