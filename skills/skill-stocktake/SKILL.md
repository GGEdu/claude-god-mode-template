...
- For **Retire**: state (1) what specific defect was found, (2) what covers the same need instead
  - Bad: `"Superseded"`
  - Good: `"disable-model-invocation: true already set; superseded by .claude/memory/lessons/ which covers all the same patterns plus confidence scoring. No unique content remains."`
